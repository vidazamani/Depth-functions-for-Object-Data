...
Estimating the Most Central Objects'***](https://www.sciencedirect.com/science/article/pii/S0167947326001167) by Zamanifarizhandi, V. and Virta, J.
...
MLD_cpp, MHD_cpp, MSD_cpp, MOD2_cpp, MOD3_cpp, coded in Rcpp. You can use them as follows:

Install the R package *MetricDepthCpp* directly from GitHub, where all the functions above are defined:
