...
1) Install the R package *MetricDepthCpp* directly from GitHub, where all the functions above are defined (recommended):
...
- Section 4.1.2 second simulation - [Simulation/large_p_simulation.R](https://github.com/vidazamani/Depth-functions-for-Object-Data/blob/main/Simulation/large_p_simulation.R).
