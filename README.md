...
2) you need to install from source the R-package MetricDepth_1.1 in the subfolder [**All Metric depth function in C++**](https://github.com/vidazamani/Depth-functions-for-Object-Data/tree/main/All%20Metric%20depth%20function%20in%20C%2B%2B).
...
- Section 5 real data examples - files ***Rank Test (AgeHist Data).R*** and ***Permutation Test (AgeHist Data).R*** in the folder [Real data examples](https://github.com/vidazamani/Depth-functions-for-Object-Data/tree/main/Real%20data%20examples).
