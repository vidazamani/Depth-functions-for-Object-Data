...
sph_data <- dget("C:/1stPaper/Codes/Simulation results on sphere dataset/data/sph_data.txt")
...
pdf(file = 
      "C:/1stPaper/Codes/Simulation results on sphere dataset/pic/error/accsent sph error new.pdf",  
...
pdf(file = 
      "C:/1stPaper/Codes/Simulation results on sphere dataset/pic/error/accsent sph error new without division.pdf",  
    width = 10, # The width of the plot in inches
    height = 6) # The height of the plot in inches
